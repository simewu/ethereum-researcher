...
import (
	...
	"github.com/simewu/ethereum-researcher/crypto/signify"
	"github.com/simewu/ethereum-researcher/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/simewu/ethereum-researcher/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/simewu/ethereum-researcher/mobile")
